...
def load_azure_subscriptions(
    ...
    ON CREATE SET
        at.firstseen = timestamp()
    SET
        at.lastupdated = $update_tag
    WITH at
        MERGE (as:AzureSubscription{id: $SUBSCRIPTION_ID})
        ON CREATE SET 
            as.firstseen = timestamp(), 
            as.path = $SUBSCRIPTION_PATH
        SET 
            as.lastupdated = $update_tag, 
            as.name = $SUBSCRIPTION_NAME, 
            as.state = $SUBSCRIPTION_STATE
    WITH as, at
